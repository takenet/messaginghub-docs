...
|-----------------------|--------------|-------------------------|--------------------|
| postmaster@analytics.msging.net | /event-track | Nenhuma | [EventTrackExtension](https://github.com/takenet/blip-sdk-csharp/blob/master/src/Take.Blip.Client/Extensions/EventTracker/EventTrackExtension.cs) |
